export function nativeSettings(value = {}) {
  ...
  return { bpm: number('bpm', 120, 40, 240), firstBeat: number('firstBeat', 2.5, 0, 120), offset: number('offset', 0, -500, 500), difficulty: ['easy', 'medium', 'expert'].includes(value?.difficulty) ? value.difficulty : 'medium', mode: value?.mode === 'strum' ? 'strum' : 'tap' };
}
